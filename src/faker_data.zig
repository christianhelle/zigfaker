...
pub const job_titles = [_][]const u8{
    ...
    "UX Designer",          "DevOps Engineer",          "Systems Architect",
    "Marketing Manager",    "Sales Representative",     "Financial Analyst",
    "Human Resources Manager", "Operations Manager",    "Project Manager",
    "Business Analyst",     "Quality Assurance Engineer","Database Administrator",
    "Network Engineer",     "Security Analyst",         "Cloud Architect",
    "Machine Learning Engineer","Backend Developer",    "Frontend Developer",
    "Full Stack Developer", "Mobile Developer",         "Technical Writer",
    "Customer Success Manager","Scrum Master",          "Chief Technology Officer",
    "Chief Executive Officer","Chief Operating Officer","Vice President of Engineering",
};
